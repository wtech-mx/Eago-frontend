     ...
     <div class="row text-center intro-title">
           ...
           <div class="col-md-6 text-md-right float-right">
             <ul class="page-breadcrumb">
                ...
                <li class="active pagActiva"><?php echo $titulo; ?></li>
             </ul>
           </div>
     </div>
  </div>
                     ...
                     <div class="masonry-item clearfix ">
                       <div class="blog-2">
                        ...
                        <a href="single.php?id=<?php echo $post['id']; ?>">
                           <img  class="img-fluid" src="https://eago.com.mx/eagoTaller/imagenes/<?php echo $post['thumb']; ?>" alt="<?php echo $post['titulo'] ?>">
                        </a>
                          <div class="date">
