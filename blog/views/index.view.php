...
<section class="latest-blog border masonry-main page-section-ptb" style="background-color: #051546;">
     ...
     <div class="container">
          ...
          <div class="col">
            ...
            <div class="card" style="background-color:#05123F;">
              ...
              <div class="card-body">
                <h3 class="cart-title"style="color:#fff;font-size:35px;"><a href="single.php?id=<?php echo $post['id']; ?>"><?php echo $post['titulo'] ?></a></h3>
                <p class="text-muted"style="color:#fff;"><?php echo fecha($post['fecha']); ?></p>
                <p class="card-text"style="color:#fff;"><?php echo $post['extracto'] ?></p>
