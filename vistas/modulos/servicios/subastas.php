...
<section class="custom-block-3 white-bg page-section-ptb">
  <div class="container">
   <div class="row">
    <div class="col-md-6">
        <div class="title">
          <h3>Quieres vender tu vehículo? <br> Nosotros te ayudamos</h3>
        </div>
        <div class="content">
          <p>Realizamos un proceso trasparente y confiable para la venta de vehículos, ponemos a tu disposición un software que garantice imparcialidad, transparencia, rapidez y eficacia en todo proceso de la venta del vehículo.
              <br><br>
            Regulamos la situación fiscal de los vehículos para deslindar a la empresa.
              <br><br>
              El software es adaptable a sus necesidades
              <br><br>
              El proceso es 100% auditable
    ...
    <div class="col-md-6">
      <img class="img-fluid" src="<?php echo $url; ?>vistas/img/subastas-persona-bg.png" alt="">
    </div>
   </div>
